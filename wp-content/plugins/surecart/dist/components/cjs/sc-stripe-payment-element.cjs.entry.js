      ...
      this.element.on('change', (event) => {
        ...
        if (event.complete) {
          this.scPaymentInfoAdded.emit({
            ...
            total_amount: (_c = mutations.state.checkout) === null || _c === void 0 ? void 0 : _c.total_amount,
            line_items: (_d = mutations.state.checkout) === null || _d === void 0 ? void 0 : _d.line_items,
            payment_method: {
              billing_details: {
                email: (_e = mutations.state.checkout) === null || _e === void 0 ? void 0 : _e.email,
                name: (_f = mutations.state.checkout) === null || _f === void 0 ? void 0 : _f.name,
              },
            },
          });
        }
